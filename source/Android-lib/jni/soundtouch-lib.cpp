//////////////////////////////////////////////////////////////////////////////
///
/// SoundTouch Lib wrapper - wraps SoundTouch routines into a Dynamic Load
/// Library interface.
///
...
////////////////////////////////////////////////////////////////////////////////
//
// $Id: SoundTouchLib.cpp 248 2017-03-05 16:36:35Z oparviai $
//
////////////////////////////////////////////////////////////////////////////////
//
// License :
...
using namespace soundtouch;
    ...
    #error "error - compile the lib version with float samples"
...
void soundtouch_setChannels(void *h, uint numChannels)
{
    STHANDLE *sth = (STHANDLE*)h;
    if (sth->dwMagic != STMAGIC) return;
...
/// Sets sample rate.
void soundtouch_setSampleRate(void *h, uint srate)
{
    STHANDLE *sth = (STHANDLE*)h;
    if (sth->dwMagic != STMAGIC) return;
...
uint soundtouch_numUnprocessedSamples(void *h)
{
    STHANDLE *sth = (STHANDLE*)h;
...
uint soundtouch_receiveSamples(void *h,
...
uint soundtouch_receiveSamples_i16(void *h,
...
uint soundtouch_numSamples(void *h)
{
    STHANDLE *sth = (STHANDLE*)h;
    if (sth->dwMagic != STMAGIC) return 0;
